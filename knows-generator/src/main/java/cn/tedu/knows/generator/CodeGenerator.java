...
public class CodeGenerator {
    ...
    public static String baseControllerClassName ;// = "cn.tedu.knows.portal.base.BaseController";
    //业务层的公共基类，用于抽象公共方法
    public static String baseServiceClassName ;   // = "cn.tedu.knows.portal.base.BaseServiceImpl";
    //作者名
    public static String author = "tedu.cn";
    //模块名称，用于组成包名
    public static String modelName = "portal";
    //Mapper接口的模板文件，不用写后缀 .ftl
    public static String mapperTempalte = "/ftl/mapper.java";//resources下
